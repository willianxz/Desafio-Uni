...
$(document).ready(function(){
   ...
   //Exibe/oculta o mini painel de cadastro de novos clientes
   togglepainelcadastro();

   //Solicita o cadastro de um novo cliente caso o formulário do painel seja submetido
   cadastrarcliente(); 
...
<div id="containercadastro">
  <form id="cadastro">
     ...
     <div class="input-group mb-3">
        ...
        <input type="text" name="cadastrarnome" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
      </div>
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" name="cadastrarcpf" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
      </div>
      ...
      <div class="input-group mb-3">
        ...
        <input type="email" name="cadastraremail" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
      </div>

      <button id="cadastrarcliente" class="btn btn-primary">Cadastrar Novo Cliente</button>
  </form>
...
<div class="col-md-4"></div>
<div id="containerclientes" class="container-fluid col-md-4" style="text-align: center;"></div>
<div class="col-md-4"></div>

<button type="button" class="btn btn-primary btn-lg btn-block" onclick="listarclientes(5);">CARREGAR MAIS</button>
